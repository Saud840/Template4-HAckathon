...
function List() {
    return(
        <div>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List1.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Accumsan tincidunt</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            </div>
            <div className="flex justify-between ml-32 mt-10">
            <img src="List2.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Accumsan tincidunt</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List3.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Vel sem</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List4.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Porttitor cum</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List5.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Nunc in</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List6.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
            <p>Vitae facilisis</p>
            <p className="flex gap-2 text-[#2c2f83]">$26.00<p className="line-through text-[#fa3d8f]">$42.00</p></p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="flex justify-between ml-32 mt-10">
            <img src="List7.jpg" alt="Product" className="w-20 h-16 sm:w-32 sm:h-32 md:w-40 md:h-36 lg:w-48 lg:h-44" />
            <div className="m-auto ml-10 mt-10 text-[#2c2f83] font-semibold">
